...
if [[ $CURRENT_MASTER == 'mysql1' ]];
then
    echo "Current primary is mysql1, exiting"
    exit 1
fi
...
INSERT INTO mysql_servers (hostgroup_id,hostname,status,port,max_replication_lag) VALUES (1,'mysql2','ONLINE',3306,1);
LOAD MYSQL SERVERS TO RUNTIME; SAVE MYSQL SERVERS TO DISK;
"
